...
from plot import reset_energy, plot_movement, plot_energies, plot_phase_portrait, plot_efforts, plot_Q
...
while True:
    ...
    efforts = make_decision(bones)
    update_model(bones, efforts)
